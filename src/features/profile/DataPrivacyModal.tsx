  ...
  return (
    <div className="fixed inset-0 z-60 bg-[rgba(35,29,24,0.30)] backdrop-blur-xs flex items-center justify-center p-4">
      <motion.div
        ...
        className="w-full max-w-md bg-[#FBF8F2] rounded-[24px] border border-[#DED6C9] shadow-[0_16px_36px_-6px_rgba(35,28,20,0.16)] p-6 font-serif-sc text-[#302820] max-h-[90vh] overflow-y-auto"
      >
